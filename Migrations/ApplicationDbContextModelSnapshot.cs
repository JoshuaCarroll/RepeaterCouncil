    ...
    partial class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public static async Task SeedExistingUsers(IServiceProvider serviceProvider)
        {
            using (var scope = serviceProvider.CreateScope())
            {
                ...
                // Retrieve the existing users from your old Users table
                var existingUsers = context.Users.ToList(); 

                foreach (var oldUser in existingUsers)
                {
                    // Check if user already exists in the new AspNetUsers table
                    ...
                    if (userExists == null)
                    {
                        var identityUser = new IdentityUser
                        {
                            ...
                            Email = oldUser.Email,
                            PasswordHash = oldUser.Password.ToString(),
                            PhoneNumber = (oldUser.PhoneCell != null && oldUser.PhoneCell != string.Empty) ? oldUser.PhoneCell : oldUser.PhoneHome
                        };

                        // Add the user to Identity with the existing hashed password
            ...
            modelBuilder.Entity("RepeaterCouncil.Models.Repeater", b =>
                {
                    ...
                    b.HasIndex(new[] { "TrusteeID" }, "Index_TrusteeID");
            ...
            modelBuilder.Entity("RepeaterCouncil.Models.User", b =>
                {
                    ...
                    b.HasKey("ID")
                        .HasName("PK__Users__3214EC27AB5231B4");
