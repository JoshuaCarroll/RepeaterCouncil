...
namespace RepeaterCouncil.Web.Areas.Identity.Pages.Account
{
    ...
    public class ResendEmailConfirmationModel : PageModel
    {
        ...
        public ResendEmailConfirmationModel(UserManager<ApplicationUser> userManager, RepeaterCouncil.Web.Services.IEmailSender emailSender)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var emailModel = new EmailConfirmationViewModel
            {
                ...
                Subject = $"Confirm your email - {tenantName}"
            };
